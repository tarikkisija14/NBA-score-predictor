...
X_train_pts_win, X_test_pts_win, y_train_pts_win, y_test_pts_win = train_test_split(X_winner, y_winner_pts, test_size=0.2, random_state=42)
...
X_train_pts_lose, X_test_pts_lose, y_train_pts_lose, y_test_pts_lose = train_test_split(X_winner, y_loser_pts, test_size=0.2, random_state=42)

model_loser_pts = RandomForestRegressor(n_estimators=100, random_state=42)
model_loser_pts.fit(X_train_pts_lose, y_train_pts_lose)

y_pred_lose_pts = model_loser_pts.predict(X_test_pts_lose)
print(f"MSE za poene gubitnika: {mean_squared_error(y_test_pts_lose, y_pred_lose_pts):.3f}")
